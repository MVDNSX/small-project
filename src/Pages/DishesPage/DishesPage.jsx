...
export const DishesPage = ({isDiscount}) => {
  ...
  const [dishFilter, setDishFilter] = useState({sortName: '', sort: '', query:'', category: 0})
	const sortedAndSearchDishes = useSortAndFilterDishes(dishes, dishFilter.category, dishFilter.query, dishFilter.sort,  isDiscount)
  return (
    <div className={c.dishes__container}>
      <Layout>
        <PageHeader header={isDiscount ? `Riverside Flames - Discount` : `Riverside Flames`} isDate>
            <CustomInput 
