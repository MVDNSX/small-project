			...
			<div className={styles.top}>
				...
				<div className={styles.dishes}>
					...
					<div className={styles.info}>
						<div className={styles.name}>Spicy seasoned seafood noodles</div>
						<div className={styles.price_one}>$ 2.29</div>
					</div>
				</div>
				<div className={styles.count}>
					<input type="text" value={10} max={10}/>
				</div>
				<div className={styles.price_all}>$ 4.58</div>
